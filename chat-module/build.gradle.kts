...
ignitionModule {
    ...
    fileName.set("RagComponents")

    // module xml configuration
    name.set("RagComponents")
    id.set("org.fakester.ragcomponent")
    ...
    hooks.putAll(
        mapOf(
            "org.fakester.gateway.RagGatewayHook" to "G",
            "org.fakester.designer.RagDesignerHook" to "D"
        )
    )
